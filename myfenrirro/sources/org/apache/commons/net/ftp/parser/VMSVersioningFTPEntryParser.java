...
public class VMSVersioningFTPEntryParser extends VMSFTPEntryParser {
    ...
    public List<String> preParse(List<String> list) {
        ...
        while (listIterator.hasNext()) {
            Matcher matcher = this._preparse_pattern_.matcher(((String) listIterator.next()).trim());
            if (matcher.matches()) {
        ...
        while (listIterator.hasPrevious()) {
            Matcher matcher2 = this._preparse_pattern_.matcher(((String) listIterator.previous()).trim());
            if (matcher2.matches()) {
