...
public class DefaultClientConnection extends SocketHttpClientConnection implements ManagedHttpClientConnection, OperatedClientConnection, HttpContext {
    ...
    public SessionInputBuffer createSessionInputBuffer(Socket socket2, int i, HttpParams httpParams) {
        SessionInputBuffer createSessionInputBuffer = super.createSessionInputBuffer(socket2, i > 0 ? i : 8192, httpParams);
    ...
    public SessionOutputBuffer createSessionOutputBuffer(Socket socket2, int i, HttpParams httpParams) {
        SessionOutputBuffer createSessionOutputBuffer = super.createSessionOutputBuffer(socket2, i > 0 ? i : 8192, httpParams);
        if (this.wireLog.isDebugEnabled()) {
    ...
    public void bind(Socket socket2) {
    ...
    public HttpResponse receiveResponseHeader() {
        ...
        if (this.headerLog.isDebugEnabled()) {
            ...
            for (Header obj : receiveResponseHeader.getAllHeaders()) {
