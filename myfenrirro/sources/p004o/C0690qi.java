...
/* renamed from: o.qi */
public final class C0690qi extends C0663pk {
    public C0690qi(C0682qa qaVar) {
        super(qaVar);
    }
    ...
    public final long mo4078(C0664if ifVar, long j, long j2) {
        long j3 = (-256418224 * j) + (((long) ((int) j2)) * 90512257);
        long j4 = j3;
    ...
    public final void mo4080(byte[] bArr, int i, int i2, C0664if ifVar) {
        ifVar.f4622 -= ifVar.f4620[(int) ifVar.f4623] * 47;
        ifVar.f4622 &= 255;
        ...
        ifVar.f4623 += ifVar.f4620[(int) ifVar.f4622] * 207;
        ifVar.f4623 &= 255;
