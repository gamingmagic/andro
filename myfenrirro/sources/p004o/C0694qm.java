...
/* renamed from: o.qm */
public final class C0694qm extends C0663pk {
    public C0694qm(C0682qa qaVar) {
        super(qaVar);
    }
    ...
    public final long mo4078(C0664if ifVar, long j, long j2) {
        long j3 = ((-1640703136 * j) - (((long) ((int) j2)) * -734875481)) + j;
        long j4 = j3;
    ...
    public final void mo4080(byte[] bArr, int i, int i2, C0664if ifVar) {
        ...
        ifVar.f4623 -= ifVar.f4620[(int) ifVar.f4621] + 93;
        ifVar.f4623 &= 255;
