...
/* renamed from: o.qc */
public final class C0684qc extends C0663pk {
    public C0684qc(C0682qa qaVar) {
        super(qaVar);
    }
    ...
    public final long mo4078(C0664if ifVar, long j, long j2) {
        long j3 = j - ((202630934 * j) - (((long) ((int) j2)) * -149799467));
        long j4 = j3;
    ...
    public final void mo4080(byte[] bArr, int i, int i2, C0664if ifVar) {
        ...
        ifVar.f4622 -= ifVar.f4620[(int) ifVar.f4621] - 243;
        ifVar.f4622 &= 255;
        ifVar.f4623 -= ifVar.f4620[(int) ifVar.f4622] - 88;
        ifVar.f4623 &= 255;
