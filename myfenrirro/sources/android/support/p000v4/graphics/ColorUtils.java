...
public final class ColorUtils {
    ...
    public static void RGBToXYZ(int i, int i2, int i3, double[] dArr) {
        ...
        double d2 = d;
        double pow = d < 0.04045d ? d2 / 12.92d : Math.pow((0.055d + d2) / 1.055d, 2.4d);
        double d3 = ((double) i2) / 255.0d;
        double d4 = d3;
        double pow2 = d3 < 0.04045d ? d4 / 12.92d : Math.pow((0.055d + d4) / 1.055d, 2.4d);
        double d5 = ((double) i3) / 255.0d;
        double d6 = d5;
        double pow3 = d5 < 0.04045d ? d6 / 12.92d : Math.pow((0.055d + d6) / 1.055d, 2.4d);
    ...
    public static void LABToXYZ(double d, double d2, double d3, double[] dArr) {
        ...
        double d8 = pow3 > XYZ_EPSILON ? pow3 : ((116.0d * d6) - 16.0d) / XYZ_KAPPA;
        dArr[0] = XYZ_WHITE_REFERENCE_X * d7;
        dArr[1] = XYZ_WHITE_REFERENCE_Y * pow2;
        dArr[2] = d8 * XYZ_WHITE_REFERENCE_Z;
    }
