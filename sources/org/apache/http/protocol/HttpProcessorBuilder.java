...
public class HttpProcessorBuilder {
    ...
    public HttpProcessor build() {
        return new ImmutableHttpProcessor((List<HttpRequestInterceptor>) this.requestChainBuilder != null ? this.requestChainBuilder.build() : null, (List<HttpResponseInterceptor>) this.responseChainBuilder != null ? this.responseChainBuilder.build() : null);
    }
}
