...
public class ResponseProcessCookies implements HttpResponseInterceptor {
    ...
    public void process(HttpResponse httpResponse, HttpContext httpContext) {
        ...
        processCookies(httpResponse.headerIterator(C2085SM.SET_COOKIE), cookieSpec, cookieOrigin, cookieStore);
        if (cookieSpec.getVersion() > 0) {
            processCookies(httpResponse.headerIterator(C2085SM.SET_COOKIE2), cookieSpec, cookieOrigin, cookieStore);
        }
    }
