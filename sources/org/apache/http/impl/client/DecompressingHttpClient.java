...
public class DecompressingHttpClient implements HttpClient {
    ...
    public HttpResponse execute(HttpHost httpHost, HttpRequest httpRequest, HttpContext httpContext) {
        ...
        if (httpContext != null) {
            ...
            try {
                httpContext2 = new BasicHttpContext();
        ...
        this.acceptEncodingInterceptor.process(httpRequest2, httpContext3);
        execute = this.backend.execute(httpHost, httpRequest2, httpContext3);
        this.contentEncodingInterceptor.process(execute, httpContext3);
        if (Boolean.TRUE.equals(httpContext3.getAttribute(ResponseContentEncoding.UNCOMPRESSED))) {
