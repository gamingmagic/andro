    ...
    public final CloseableHttpResponse doExecute(HttpHost httpHost, HttpRequest httpRequest, HttpContext httpContext) {
        ...
        synchronized (this) {
            ...
            if (httpContext == null) {
                ...
                httpContext2 = new DefaultedHttpContext(httpContext, createHttpContext);
            }
            ...
            ConnectionBackoffStrategy connectionBackoffStrategy2 = getConnectionBackoffStrategy();
            BackoffManager backoffManager2 = getBackoffManager();
            ...
            determineRoute = routePlanner2.determineRoute(httpHost2, httpRequest, httpContext2);
