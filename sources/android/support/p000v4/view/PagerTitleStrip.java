...
public class PagerTitleStrip extends ViewGroup implements Decor {
    ...
    public void onAttachedToWindow() {
        ...
        viewPager2.setInternalPageChangeListener(this.mPageListener);
        viewPager2.setOnAdapterChangeListener(this.mPageListener);
    ...
    public void updateText(int i, PagerAdapter pagerAdapter) {
        ...
        int makeMeasureSpec = MeasureSpec.makeMeasureSpec(Math.max(0, (int) (((float) ((getWidth() - getPaddingLeft()) - getPaddingRight())) * 0.8f)), ExploreByTouchHelper.INVALID_ID);
        int makeMeasureSpec2 = MeasureSpec.makeMeasureSpec(Math.max(0, (getHeight() - getPaddingTop()) - getPaddingBottom()), ExploreByTouchHelper.INVALID_ID);
    ...
    public void updateTextPositions(int i, float f, boolean z) {
        ...
        int measuredHeight = i12 + this.mNextText.getMeasuredHeight();
        int max2 = Math.max(Math.max(i10 + this.mPrevText.getMeasuredHeight(), i11 + this.mCurrText.getMeasuredHeight()), measuredHeight);
