...
public class SlidingPaneLayout extends ViewGroup {
    ...
    class DragHelperCallback extends Callback {
        ...
        public void onViewReleased(View view, float f, float f2) {
            ...
            if (SlidingPaneLayout.this.isLayoutRtlSupport()) {
                ...
                i = SlidingPaneLayout.this.getPaddingLeft() + layoutParams.leftMargin;
                if (f > 0.0f || (f == 0.0f && SlidingPaneLayout.this.mSlideOffset > 0.5f)) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    i5 = MeasureSpec.makeMeasureSpec(i9 - i11, ExploreByTouchHelper.INVALID_ID);
                } else if (layoutParams.width == -1) {
                    i5 = MeasureSpec.makeMeasureSpec(i9 - i11, 1073741824);
                } else {
                    i5 = MeasureSpec.makeMeasureSpec(layoutParams.width, 1073741824);
                }
                if (layoutParams.height == -2) {
                    i6 = MeasureSpec.makeMeasureSpec(i8, ExploreByTouchHelper.INVALID_ID);
                } else if (layoutParams.height == -1) {
                    i6 = MeasureSpec.makeMeasureSpec(i8, 1073741824);
                } else {
                        ...
                        if (!z || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                if (layoutParams2.width != 0) {
                                    ...
                                    i3 = MeasureSpec.makeMeasureSpec(i8, ExploreByTouchHelper.INVALID_ID);
                                ...
                                if (z) {
                                    int i14 = i9 - (layoutParams2.leftMargin + layoutParams2.rightMargin);
                                    int makeMeasureSpec = MeasureSpec.makeMeasureSpec(i14, 1073741824);
                                    if (measuredWidth2 != i14) {
                                        childAt2.measure(makeMeasureSpec, i3);
                                    }
                                } else {
                                    childAt2.measure(MeasureSpec.makeMeasureSpec(measuredWidth2 + ((int) ((layoutParams2.weight * ((float) Math.max(0, paddingLeft))) / f)), 1073741824), i3);
                                }
                            }
                            ...
                            if (!z3) {
                                ...
                                i4 = MeasureSpec.makeMeasureSpec(i8, ExploreByTouchHelper.INVALID_ID);
                            } else if (layoutParams2.height == -1) {
                                i4 = MeasureSpec.makeMeasureSpec(i8, 1073741824);
                            } else {
                                i4 = MeasureSpec.makeMeasureSpec(layoutParams2.height, 1073741824);
                            }
                            childAt2.measure(MeasureSpec.makeMeasureSpec(i12, 1073741824), i4);
                        }
                    }
                }
            }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                int i11 = 0;
                if (layoutParams.slideable) {
                    int min = (Math.min(i8, (i7 - paddingLeft) - this.mOverhangSize) - i9) - (layoutParams.leftMargin + layoutParams.rightMargin);
                    this.mSlideRange = min;
                    int i12 = isLayoutRtlSupport ? layoutParams.rightMargin : layoutParams.leftMargin;
                    layoutParams.dimWhenOffset = ((i9 + i12) + min) + (measuredWidth / 2) > i7 - paddingLeft;
    ...
    public void onPanelDragged(int i) {
        ...
        this.mSlideOffset = ((float) ((isLayoutRtlSupport ? (getWidth() - i) - this.mSlideableView.getWidth() : i) - ((isLayoutRtlSupport ? layoutParams.rightMargin : layoutParams.leftMargin) + (isLayoutRtlSupport ? getPaddingRight() : getPaddingLeft())))) / ((float) this.mSlideRange);
        if (this.mParallaxBy != 0) {
            parallaxOtherViews(this.mSlideOffset);
        }
    ...
    public boolean smoothSlideTo(float f, int i) {
        ...
        LayoutParams layoutParams = (LayoutParams) this.mSlideableView.getLayoutParams();
        if (isLayoutRtlSupport()) {
            i2 = (int) (((float) getWidth()) - ((((float) (getPaddingRight() + layoutParams.rightMargin)) + (((float) this.mSlideRange) * f)) + ((float) this.mSlideableView.getWidth())));
        } else {
            i2 = (int) (((float) (getPaddingLeft() + layoutParams.leftMargin)) + (((float) this.mSlideRange) * f));
        }
    ...
    private void parallaxOtherViews(float r10) {
        /*
            r9 = this;
            boolean r2 = r9.isLayoutRtlSupport()
        ...
        L_0x0022:
            ...
            float r0 = r9.mParallaxOffset
            r1 = 1065353216(0x3f800000, float:1.0)
            float r0 = r1 - r0
            int r1 = r9.mParallaxBy
            float r1 = (float) r1
            float r0 = r0 * r1
            int r7 = (int) r0
        ...
        L_0x0054:
            ...
            float r0 = r1 - r0
        L_0x005a:
            int r1 = r9.mCoveredFadeColor
            r9.dimChildView(r6, r0, r1)
        L_0x005f:
            int r5 = r5 + 1
            goto L_0x0022
        L_0x0063:
