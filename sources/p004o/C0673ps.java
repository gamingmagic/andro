...
/* renamed from: o.ps */
public final class C0673ps extends C0663pk {
    public C0673ps(C0682qa qaVar) {
        super(qaVar);
    }
    ...
    public final long mo4078(C0664if ifVar, long j, long j2) {
        long j3 = (1510103324 * j) + (((long) ((int) j2)) * -31757033) + j;
        long j4 = j3;
    ...
    public final void mo4080(byte[] bArr, int i, int i2, C0664if ifVar) {
        ifVar.f4623 -= ifVar.f4620[(int) ifVar.f4621] * 23;
        ifVar.f4623 &= 255;
        ...
        ifVar.f4622 += ifVar.f4620[(int) ifVar.f4621] * 253;
        ifVar.f4622 &= 255;
