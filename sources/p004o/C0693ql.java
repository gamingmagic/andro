...
/* renamed from: o.ql */
public final class C0693ql extends C0663pk {
    public C0693ql(C0682qa qaVar) {
        super(qaVar);
    }
    ...
    public final long mo4078(C0664if ifVar, long j, long j2) {
        long j3 = (246435560 * j) + (((long) ((int) j2)) * -1401824782) + j;
        long j4 = j3;
    ...
    public final void mo4080(byte[] bArr, int i, int i2, C0664if ifVar) {
        ifVar.f4623 -= ifVar.f4620[(int) ifVar.f4621] * 142;
        ifVar.f4623 &= 255;
        ...
        ifVar.f4622 += ifVar.f4620[(int) ifVar.f4621] * 103;
        ifVar.f4622 &= 255;
