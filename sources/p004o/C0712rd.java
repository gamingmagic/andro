...
/* renamed from: o.rd */
public final class C0712rd extends C0663pk {
    public C0712rd(C0682qa qaVar) {
        super(qaVar);
    }
    ...
    public final long mo4078(C0664if ifVar, long j, long j2) {
        long j3 = (2045845732 * j) + (((long) ((int) j2)) * 1056948940);
        long j4 = j3;
        ifVar.f4620[(int) j2] = (j3 >> 7) & 255;
        return j4;
    }
    ...
    public final void mo4080(byte[] bArr, int i, int i2, C0664if ifVar) {
        ifVar.f4623 += ifVar.f4620[(int) ifVar.f4622] * 147;
        ifVar.f4623 &= 255;
        ...
        ifVar.f4622 += ifVar.f4620[(int) ifVar.f4621] * 211;
        ifVar.f4622 &= 255;
