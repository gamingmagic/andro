...
/* renamed from: o.pt */
public final class C0674pt extends C0663pk {
    public C0674pt(C0682qa qaVar) {
        super(qaVar);
    }
    ...
    public final long mo4078(C0664if ifVar, long j, long j2) {
        long j3 = ((-1249336306 * j) - (473368885 * j2)) + j;
        long j4 = j3;
    ...
    public final void mo4080(byte[] bArr, int i, int i2, C0664if ifVar) {
        ...
        ifVar.f4622 += ifVar.f4620[(int) ifVar.f4621] * 51;
        ifVar.f4622 &= 255;
        ifVar.f4623 -= ifVar.f4620[(int) ifVar.f4623] - 191;
        ifVar.f4623 &= 255;
