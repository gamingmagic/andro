...
/* renamed from: o.qv */
public final class C0703qv extends C0663pk {
    public C0703qv(C0682qa qaVar) {
        super(qaVar);
    }
    ...
    public final long mo4078(C0664if ifVar, long j, long j2) {
        long j3 = (113079424 * j) - (((long) ((int) j2)) * 1339871049);
        long j4 = j3;
    ...
    public final void mo4080(byte[] bArr, int i, int i2, C0664if ifVar) {
        ...
        ifVar.f4622 -= ifVar.f4620[(int) ifVar.f4623] * 201;
        ifVar.f4622 &= 255;
