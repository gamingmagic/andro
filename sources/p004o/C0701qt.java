...
/* renamed from: o.qt */
public final class C0701qt extends C0663pk {
    public C0701qt(C0682qa qaVar) {
        super(qaVar);
    }
    ...
    public final long mo4078(C0664if ifVar, long j, long j2) {
        long j3 = j - ((111457810 * j) + (((long) ((int) j2)) * 1172624774));
        long j4 = j3;
    ...
    public final void mo4080(byte[] bArr, int i, int i2, C0664if ifVar) {
        ...
        ifVar.f4623 += ifVar.f4620[(int) ifVar.f4622] + 171;
        ifVar.f4623 &= 255;
        ifVar.f4622 -= ifVar.f4620[(int) ifVar.f4621] * 47;
        ifVar.f4622 &= 255;
