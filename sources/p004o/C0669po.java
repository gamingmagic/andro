...
/* renamed from: o.po */
public final class C0669po extends C0663pk {
    public C0669po(C0682qa qaVar) {
        super(qaVar);
    }
    ...
    public final long mo4078(C0664if ifVar, long j, long j2) {
        long j3 = j - ((1490439232 * j) + (((long) ((int) j2)) * -616235757));
        long j4 = j3;
    ...
    public final void mo4080(byte[] bArr, int i, int i2, C0664if ifVar) {
        ...
        ifVar.f4622 &= 255;
        ifVar.f4623 += ifVar.f4620[(int) ifVar.f4622] * 126;
        ifVar.f4623 &= 255;
